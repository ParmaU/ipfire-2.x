...
'addons' => 'Addons',
'admin user password has been changed' => '&egrave stata modificata la Passwor di Admin.',
...
'wlan client advanced settings' => 'impostazioni avanzate',
'wlan client and' => 'and',
