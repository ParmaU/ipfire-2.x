...
'wlan client configuration' => 'Configurazione client wireless',
'wlan client disconnected' => 'Disconnesso',
'wlan client duplicate ssid' => 'SSID Dupòlicato',
...
'wlanap informations' => 'Informazioni',
'wlanap interface' => 'Selezione interfaccia',
'wlanap invalid wpa' => 'Lunghezza non valida in WPA_Passphrase. Deve contenere dai 6 ai 63 caratteri.',
'wlanap link dhcp' => 'Configurazione Wireless Lan DHCP',
'wlanap link wireless' => 'Activate Wireless Lan clients',
'wlanap no interface' => 'L'interfaccia selezionata non è una scheda LAN wireless!',
'wlanap none' => 'none',
'wlanap notifications' => 'notifiche',
'wlanap select interface' => 'Seleziona l'interfaccia Wireless.',
