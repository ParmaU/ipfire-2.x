...
'advproxy NCSA group' => 'Gruppo',
'advproxy NCSA group membership' => 'Group membership',
'advproxy NCSA grp disabled' => 'Disabilitato',
'advproxy NCSA grp extended' => 'Estesa',
'advproxy NCSA grp standard' => 'Standard',
'advproxy NCSA min password length' => 'Lunghezza minima della password',
'advproxy NCSA no accounts' => 'Nessun account utente disponibili',
...
'wlanap country' => 'Prefisso internazionale',
...
'wlanap link dhcp' => 'Configuratione DHCP rete senza fili',
'wlanap link wireless' => 'Activate Wireless Lan clients',
'wlanap no interface' => 'Selected interface is not a Wirless Lan card!',
'wlanap none' => 'none',
'wlanap notifications' => 'Notifiche',
'wlanap select interface' => 'Si prega di selezionare l'interfaccia senza fili.',
...
'your department' => 'Reparto',
'your e-mail' => 'Il tuo indirizzo di posta elettronica',
);
