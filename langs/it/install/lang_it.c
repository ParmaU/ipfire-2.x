...
"Impossibile eseguire la scansione dei dispositivi ISDN.",
/* TR_PROBING_ISDN */
"Scansione e configurazione dei dispositivi ISDN.",
/* TR_MISSING_GREEN_IP */
"Manca IP rete verde!",
/* TR_CHOOSE_FILESYSTEM */
"Si prega di scegliere il filesystem:",
/* TR_NOT_ENOUGH_INTERFACES */
"Schede di rete insufficiente per la tua scelta.\n\nNecessario: %d - Disponibile: %d\n",
/* TR_INTERFACE_CHANGE */
"Si prega di scegliere l'interfaccia che si desidera modificare.\n\n",
/* TR_NETCARD_COLOR */
"Assegna Scheda",
/* TR_REMOVE */
"Rimuovi",
...
"Manca DNS.\n",
/* TR_MISSING_DEFAULT */
"Default Gateway Mancante.\n",
/* TR_JOURNAL_EXT3 */
"Creazione del diario per Ext3...",
/* TR_CHOOSE_NETCARD */
"Scegliere una scheda di rete per la seguente interfaccia - %s.",
/* TR_NETCARDMENU2 */
"Menu di Rete esteso",
/* TR_ERROR_INTERFACES */
"Non esistono interfacce libere sul tuo sistema.",
/* TR_REMOVE_CARD */
...
"Tutte le schede assegnate correttamente.",
/* TR_AUTODETECT */
"* AUTODETECT *",
/* TR_BUILDING_INITRD */
"Building ramdisk...",
...
"Scegliere la scheda ISDN installata nel sistema.",
...
/* TR_NO_LOCAL_SOURCE */
"Nessun supporto locale trovato. Parte il download.",
/* TR_DOWNLOADING_ISO */
"Scarica e installa immagine ...",
/* TR_DOWNLOAD_ERROR */
...
"Porta selezionato dovrebbe lampeggiare ...",
